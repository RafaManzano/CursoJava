...
public class Metodos {
	...
	public static List<Empleado> listadoLleno(){
		...
		empleado1 = new Empleado("Jorge", "Alonso", "López", TipoDpto.RRHH,4500.00);
		empleado2 = new Empleado("Sixto", "Alonso", "Rubio", TipoDpto.RRHH,2450.00);
		empleado3 = new Empleado("Antonio Jesus", "Cabeza", "Gordillo", TipoDpto.INFORMATICA,2480.00);
		empleado4 = new Empleado("David", "Hidalgo", "Duarte", TipoDpto.INFORMATICA,2485.00);
		empleado5 = new Empleado("Blanca", "Fustero", "Oria", TipoDpto.FINANZAS,2580.00);
		empleado6 = new Empleado("Alberto", "Hidalgo", "Duarte", TipoDpto.FINANZAS,3000.00);
		empleado7 = new Empleado("David", "Luna", "Roque", TipoDpto.CONTABILIDAD,2580.00);
